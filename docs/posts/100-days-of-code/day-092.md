...
[CIDER logo in Clojure SVG syntax](https://github.com/practicalli-johnny/webapp-status-monitor/commit/ce60f78c35ce737333c9b9b24b83caca6b49b596){target=_blank .md-button}
...
Created a rough version of the CIDER logo using Clojure SVG (hiccup) syntax.  Taking the HTML code for the logo, converted it to the Clojure SVG syntax.
