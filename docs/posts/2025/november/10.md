...
The maintainers of Material for MkDocs are now developing [](https://zensical.org/docs/get-started/){target=_blank}, a complete re-write of the static site generator.
