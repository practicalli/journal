...
Material for MkDocs project is now in maintenance mode and the maintainers started a new project from scratch.  The new project is called Zensical and resolves design decisions that were intrenched in the Material for MkDocs project.
