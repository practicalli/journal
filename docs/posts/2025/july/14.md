...
Shimano details from the SigmaSports website:

- [Shimano R8000 11/32](https://www.sigmasports.com/item/Shimano/Ultegra-R8000-11-Speed-Cassette-11-32T/FVR5){target=_blank .md-button}
- [Shimano R8000 11/30](https://www.sigmasports.com/item/Shimano/Ultegra-R8000-11-Speed-Cassette-11-30T/FVR4){target=_blank .md-button}
- [Shimano R8000 11/28](https://www.sigmasports.com/item/Shimano/Ultegra-R8000-11-Speed-Cassette-11-28T/FVR6){target=_blank}


ZTTO prices are from the ZTTO Official store on AliExpress.


Update: I decided to stick with Shimano cassettes for reliability.  On flat terrain the ZTTO cassettes should work well, but may be over-stressed on significant ascents (like the Kent Alps).  Weight will be saved by acquiring lightweight Fulcrum aluminium wheels.
