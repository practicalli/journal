...
After posting an update on the new Practicalli Astro5

Opening a babashka file, with `.bb` file name extension, sets the filetype to bitbake rather than Clojure.
