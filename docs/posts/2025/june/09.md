...
I found a [solution to GTK4 apps not using the dark theme](#configure-dark-theme-for-gtk4-apps) in i3 (Regoligth), so the world is a happy place again :face_with_rolling_eyes:
