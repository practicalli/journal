...
Its March already and I am feeling much better about how my health is improving and I should be able to get a lot of interesting work done this month :fingers-crossed:
...
Unfortunately this didnt work (at least not yet - maybe a reboot is required?).  I remove the global spare using the Storage Manager in the Admin console
...
Hopefully the this drive that overheated will hold on long enough for the RAID array to become healthy.  Then I will swap out the failing drive for a relatively new one.
