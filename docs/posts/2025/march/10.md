...
The `libtreesitter` package has been superceeded and additional pacjages created `tree-sitter`,`tree-sitter-c`, `tree-sitter-nvim` and `tree-sitter-parsers` packages
