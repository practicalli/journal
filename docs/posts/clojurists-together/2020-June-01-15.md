---
title: Community Update August June 1st Half
date: 2020-06-15
categories:
  - clojurists-together
---
...
Expanded on Getting Started section, converting to Clojure CLI and tools.deps.

Examples on using Clojure CLI tools to evaluate functions, load files and run applications.
