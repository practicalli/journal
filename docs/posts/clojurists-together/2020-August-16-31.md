---
title: Community Update August 2020 2nd Half
date: 2020-08-31
authors:
  - practicalli
categories:
...
[Additional aliases added for lambdaisland/kaocha](https://github.com/practicalli/clojure-cli-config) to support ClojureScript test runner, BDD style tests, code coverage and junit-xml reports for CI tools and wall-boards.
...
Created a install walk through guide for Conjure that supports those new to Neovim (as I was) which will be added to the [Clojure aware editors section](http://practical.li/clojure/clojure-editors/) in Practicalli Clojure.
