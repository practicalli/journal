...
I finalised the [Debian Linux Post Install scripts](#debian-linux) and separated each tool into its own script, learning a bit more [Shell Scripting syntax](#bash-scripting) along the way.
