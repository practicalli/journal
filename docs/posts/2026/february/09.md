...
I continue to [evaluate Zensical](#zensical) as the next tool for Practicalli books and blogs.  I found a more effective way to install and upgrade zensical that also removes the need for python specific configuration files.
