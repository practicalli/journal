...
The [Ubuntu Slim](https://github.com/actions/runner-images/blob/main/images/ubuntu-slim/ubuntu-slim-Readme.md){target=_blank} GitHub runner image is used to save on resources used as only Python is required on top of a basic OS image.
